  ...
  connectedCallback() {
    this.innerHTML = `
      <header>
        ...
        <img src="/asset/image/taiphim4k.png" class="oppp">
            Phim<span>4K</span>
        </a>
        <!--Menu------------------------->
        <nav>
        ...
        <ul class="menu">
            <li><a href="/OPT/index.html">Trang Chủ</a></li>
            <li><a href="/OPT/phimle/phimle.html">Phim Lẻ</a></li>
            <li><a href="/OPT/phimbo/phimbo.html">Phim Bộ</a></li>
            <li><a href="/OPT/khophim/khophim.html">Kho Phim</a></li>
            <li><a href="/OPT/topphim.html">Top Phim</a></li>
        </ul>
        </nav>
          ...
          <div class="swiper-wrapper">
              ...
              <div class="swiper-slide">
                  ...
                  <a href="/play-page-1/A11.html">
                      <img src="https://flxt.tmsimg.com/assets/p9248224_b_v8_ax.jpg" alt="" class="img">
                      <div class="box-text">
    ...
    connectedCallback() {
      ...
      <!---Today-->
                ...
                <a href="/play-page-1/A86.html">
                    <div class="box-img">
                    <img src="https://flxt.tmsimg.com/assets/p35599_v_v10_ac.jpg" alt="" class="img"></div>
                </a>
                    <div class="box-text">
                ...
                <li class="list-box">
                    ...
                    <li class="list-box">
                        <a href="/Xemphim/Jujustu Kaisen/s1/e9.html">
                            <div class="box-img">
                            <img src="https://flxt.tmsimg.com/assets/p19249972_e_h8_aa.jpg" alt="" class="img"></div>
 ...
 class gravityfrelate extends HTMLElement {
  ...
  <div class="season-content swiper">
      ...
      <li class="movie-box">
                <a href="/play-page-1/A11.html">
                    <div class="box-img">
                    <img src="https://flxt.tmsimg.com/assets/p9248224_b_v8_ax.jpg" alt="" class="img"></div>
      ...
      <li class="movie-box">
        <a href="/Xemphim/gravityfall/s2/1.html">
            <div class="box-img">
            <img src="https://flxt.tmsimg.com/assets/p10851882_i_v9_aa.jpg" alt="" class="img"></div>
  ...
  <div class="list-content">
      ...
      <li class="list-box">
          <a href="/Xemphim/overlord/s3/8.html">
              <div class="box-img">
              <img src="https://flxt.tmsimg.com/assets/p16245504_i_h9_aa.jpg" alt="" class="img"></div>
...
const movie = [
  ...
  {
    id: 26,
    img: "https://ntvb.tmsimg.com/assets/p23905086_v_h8_aa.jpg?ihspl",
  ...
  {
    id: 22,
    img: "https://assets-prd.ignimgs.com/2023/07/26/re-death-island-1690379861492.jpg",
